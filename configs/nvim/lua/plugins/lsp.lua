-- LSP Configuration
--
-- Configures nvim-lspconfig with diagnostic display, keymaps, and floating diagnostics.
-- Language server setup is in mason.lua; schema-aware servers in schema-companion.lua.
--
