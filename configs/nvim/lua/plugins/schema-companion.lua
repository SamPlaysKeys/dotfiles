-- Schema Companion: Schema-Aware Language Servers
--
-- Enhances yamlls, jsonls, helm_ls, and taplo with schema detection.
-- Includes Kubernetes, OpenShift, and Ansible schema sources.
--
