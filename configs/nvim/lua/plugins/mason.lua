...
--
-- Installs and configures language servers via mason-lspconfig.
-- Servers: lua_ls, pyright, ts_ls, ansiblels, powershell_es, jinja_lsp.
-- Schema-aware servers (yamlls, jsonls, helm_ls, taplo) are in schema-companion.lua.
--
